        ...
        <div class="container">
            <div>
                <div class="grid grid-cols-2 gap-x-7">
                    ...
                    <div>
                        <div class="text-2xl font-bold mb-4">{{ $project['name'] }}</div>
...
{{--                            </div>--}}
                            <div class="flex">
                                <div class="flex-1 font-bold pr-2">Periode Pengerjaan</div>
                                <div class="flex-1">{{ $project['work_period'] }}</div>
                            </div>
                            <div class="flex">
                                <div class="flex-1 font-bold pr-2">Budget Maksimal</div>
                                <div class="flex-1">{{ convertCurrency($project['budget']) }}</div>
                            </div>
{{--                            <div class="flex">--}}
...
{{--                            </div>--}}
                ...
                @if($user)
                    @if($user->role->name == 'penyedia')
                        <div class="mt-8 text-right">
                            <a href="{{ route('page.profile', ['section' => 'project']) }}" class="btn btn-primary">Daftar Pelamar</a>
                        </div>
                    @endif
                @endif
            </div>
...
{{--    </section>--}}
    ...
    <section class="py-20 bg-gray-50">
        <div class="container">
            <div class="text-3xl mb-4">Project Lainnya</div>

    ...
    public function index(){
        if (Auth::check()) {
            ...
            if ($user->role) {
                ...
                'projects'=>ProjectHeader::inRandomOrder($user->project_headers->count())->simplePaginate(3)]);
            }else {
                ...
                'projects'=>ProjectHeader::inRandomOrder($user->project_details->count())->simplePaginate(3)]);
            }
        }else {
            return view('front.homepage', ['projects'=>ProjectHeader::inRandomOrder(ProjectHeader::count())->simplePaginate(6)]);
        }
    }

    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <!-- Form -->
                    <form action="{{ route('admin.journal.store') }}" method="POST" class="mt-2" id="blog-form" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-12 mb-2">
                                <div class="border rounded p-2">
                                    ...
                                    <div class="media flex-column flex-md-row">
                                        <img src="/app-assets/images/placeholder.jpeg" id="blog-feature-image"
                                            ...
                                            <div class="d-inline-block">
                                                <div class="form-group mb-0">
                                                    <div class="custom-file">
                                                        <input required name="image" type="file" class="custom-file-input" id="blogCustomFile"
                                                            accept="image/*" />
